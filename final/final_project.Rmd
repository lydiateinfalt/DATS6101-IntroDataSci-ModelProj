...
We can quickly view all the empty elements in our data, which, as part of our cleaning, we will remove:
...
Just quickly visualizing the correlation will be useful for model building, but we have to be mindful of the fact that columns such as Medal and Medal.No.Yes are naturally going to be highly correlated.
