...
## Total Number of Summer Event Olympic Medals vs. Year 
```{r }
loadPkg(dplyr)
...
ggplot(data=olympics_summer_medals, aes(x=Year, y=Medals)) +
  geom_bar(stat="identity", fill="steelblue")+ylab("Total Number of Medals (Summer)") + theme_minimal()
...
## Using 1908-1928 Time Series as Training Data - Italy
```{r forecast1}
