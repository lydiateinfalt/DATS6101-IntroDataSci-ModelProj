...
actual = c(132, 144, NA)))
colnames(hw_summary) <- c("Year", "Predicted Medals", "Actual Medals")

hw_summary %>%
  kable(caption = "Holt-Winters and ETS-ANN Forecast") %>%
  kable_styling()


```
The Cubic-Spline predicts for 2020, Italy will earn 117 medals.
